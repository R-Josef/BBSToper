...
public enum Option {
	DEBUG("debug"), DATABASE_TYPE("database.type"), DATABASE_PREFIX("database.prefix"),
	DATABASE_TIMINGRECONNECT("timingreconnect"), DATABASE_MYSQL_IP("database.mysql.ip"),
	...
	GUI_TOPPLAYERS("gui.topplayers"), GUI_DISPLAYHEADSKIN("gui.displayheadskin"), GUI_USECHATGETID("gui.usechatgetid"),
